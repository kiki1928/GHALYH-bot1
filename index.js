...
*/
const XPTN = 'GHALYH BOT'; // Nama Bot Whatsapp
...
const groupwa = 'https://chat.whatsapp.com/G3yYhho2lz4D3UiruLHp1M'; // OFFICIAL GRUP LU 1
const youtube = 'coming soon'; // OFFICIAL GRUP LU 2
//
...
conn.sendMessage(id, ' _Thanks Telah Menggunakan BOT *GHALYH BOT* , Follow Instagram Mimin Yah😻 : https://instagram.com/ghlyhalamn' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _Thanks Telah Menggunakan BOT *GHALYH BOT* , Follow Instagram Mimin Yah😻 : https://instagram.com/ghlyhalamn' ,MessageType.text);
}
